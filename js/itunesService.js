angular.module('itunes').service('itunesService', function($http, $q){
  ...
  //Also note that we're using a 'service' and not a 'factory' so all your methods
  //you want to call in your controller need to be on 'this'.

  //Write a method that accepts an artist's name as the parameter, then makes a
  //'JSONP' http request to a url that looks like this
  ...
  //manipulate the data before you resolve it.
      ...
      .then(function(response){
        ...
        for(var i = 0; i<results.length; i++){
          var songObj = {
            ...
            Type: results[i].primaryGenreName,
    ...
    // Go to the next step in the README (Tie in your controller). You will come
    //back to these instructions shortly.
    //
    // You need to sort the data you get back from the itunes API to be an object
  ...
  */
  ...
  // new array objects that look like the above data. Make sure your method returns
  // this finalized array of data.
